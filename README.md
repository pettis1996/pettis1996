...
With **3+ years of experience**, I focus mainly on **Frontend Development** using **Next.js** and **TypeScript**, but I also enjoy diving into the **backend** with **Python (FastAPI)** and databases like **PostgreSQL**, **MySQL**, and **MongoDB**.  
